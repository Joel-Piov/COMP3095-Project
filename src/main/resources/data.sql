INSERT INTO client (id, address, city, country, postal_code, email, first_name, last_login_date, last_name, last_profile_update, date_of_birth, password, register_date, role) VALUES
(1, '123 Test Street', 'Toronto', 'Canada', 'B1B 1B1', 'admin@isp.net', 'John', '2020-12-05', 'Doe', '2020-12-01', '1969-01-01', 'P@ssword1', '2020-12-01', 'Admin');

INSERT INTO client (id, address, city, country, postal_code, email, first_name, last_login_date, last_name, last_profile_update, date_of_birth, password, register_date, role) VALUES
(3, '123 Test Street', 'Toronto', 'Canada', 'C1C 1C1', 'DD@isp.net', 'Don', '2020-12-05', 'Draper', '2020-12-01', '1969-01-01', 'P@ssword1', '2020-12-01', 'Admin');

INSERT INTO client (id, address, city, country, postal_code, email, first_name, last_login_date, last_name, last_profile_update, date_of_birth, password, register_date, role) VALUES
(2, '123 Test Street', 'Toronto', 'Canada', 'A1A 1A1', 'client@isp.net', 'Jane', '2020-12-05', 'Smith', '2020-12-01', '1990-01-01', 'P@ssword1',  '2020-12-01', 'Client');
