INSERT INTO client (id, address, city, country, postal_code, email, first_name, last_name, date_of_birth, password, role) VALUES
(1, '123 Test Street', 'Toronto', 'Canada', 'B1B 1B1', 'admin@isp.net', 'John', 'Doe', '1969-01-01', 'P@ssword1', 'Admin');

INSERT INTO client (id, address, city, country, postal_code, email, first_name, last_name, date_of_birth, password, role) VALUES
(3, '123 Test Street', 'Toronto', 'Canada', 'C1C 1C1', 'DD@isp.net', 'Don', 'Draper', '1969-01-01', 'P@ssword1', 'Admin');
